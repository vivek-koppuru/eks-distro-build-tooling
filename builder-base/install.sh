...
cp ${GOPATH}/bin/go${GOLANG113_VERSION} ${GOPATH}/go${GOLANG113_VERSION}/bin/go
...
cp ${GOPATH}/bin/go${GOLANG114_VERSION} ${GOPATH}/go${GOLANG114_VERSION}/bin/go
...
cp ${GOPATH}/bin/go${GOLANG115_VERSION} ${GOPATH}/go${GOLANG115_VERSION}/bin/go
